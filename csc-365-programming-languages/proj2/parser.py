...
def foldr(f, s, vals) :
    if vals == []:
        ...
        return f(vals[0], foldr(f, s, vals[1:]))
...
# I haven't yet figured out how to do comments
...
lexer = lex(lextab="jay_lextab.py")
parser = yacc(tabmodule="jay_parsetab.py", debug=False)
